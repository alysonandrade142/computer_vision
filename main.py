...
def vertical(img):
    ...
    # O valor 20 foi através de experimentação e nos deu um melhor resultado final,
    # quanto menor o valor maior foi a abstração do resultado final.
    ...
    # Aplicamos a erosão na imagem (valorizamos os pixels com os menores valores, entre 0 e 1 sempre será escolhido o menor)
...
colored = cv.imread('dataset/3.png', cv.IMREAD_COLOR)
